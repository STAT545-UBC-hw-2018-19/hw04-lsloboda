...
* The kableExtra package gives new options for styling tables!
...
#   kable(col.names = c("Weapon", "Attack Type", "Wielding Type", "Damage (HP)", "Chance to Stun")) %>% 
...
kable(
  list(lj, rj),
  col.names = c("Weapon", "Attack Type", "Wielding Type", "Damage (HP)", "Chance to Stun"))
```
